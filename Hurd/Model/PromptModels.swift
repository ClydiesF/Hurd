...
"""
    ...
    static func getActivities(location: String) -> String {
        """
      Create a list of 4 activities for a trip to \(location). Provide the list in a JSON formatted string that can be decoded by the following model in Swift.
...
//create an list of 5 activities for a trip to \(location). Provide the list in a JSON formatted string with no backticks that can be decoded by the following model in swift.
//
//struct Activity: Codable, Hashable {
// let type: String
// let name: String
